...
async function workspaceSubmit(event){
 ...
 try{
  ...
  if(form.matches('[data-system-form]')){
   const body={globalPrompt:form.globalPrompt.value,minimumClientVersion:form.minimumClientVersion.value.trim(),latestClientVersion:form.latestClientVersion.value.trim(),defaultModel:form.defaultModel.value.trim(),featureExpandedMode:form.featureExpandedMode.checked,featureManualClientContext:form.featureManualClientContext.checked};
