...
async function workspaceSubmit(event){
 ...
 try{
  ...
  if(form.matches('[data-system-form]')){
   const body={globalPrompt:'',minimumClientVersion:form.minimumClientVersion.value.trim(),latestClientVersion:form.latestClientVersion.value.trim(),clientDownloadUrl:form.clientDownloadUrl.value.trim(),defaultModel:form.defaultModel.value.trim(),featureExpandedMode:form.featureExpandedMode.checked,featureManualClientContext:false};
